...
void setup(void){
  ...
  wifiMulti.addAP("louguangxing", "13566717563"); // 这3个WiFi网络名称分别是taichi-maker, taichi-maker2, taichi-maker3。
...
//--------"启动网络服务功能"程序部分开始-------- //  此部分为程序为本示例程序重点1
  esp8266_server.begin();                   //  启动网络服务器，详细讲解请参见太极创客网站《零基础入门学用物联网》
  esp8266_server.on("/", handleRoot);       //  当浏览器想要访问首页时，调用handleRoot函数来提供首页信息。
